        ...
        apiService.addFraseValues(frase, fecha, idAutor, idCategoria).enqueue(new Callback<Boolean>() {
            ...
            public void onResponse(Call<Boolean> call, Response<Boolean> response) {
                if(response.isSuccessful()) {
                    if(response.body()) {
                        Log.i(UserActivity.class.getSimpleName(), "Frase añadida correctamente");
                    } else {
                        Log.i(UserActivity.class.getSimpleName(), "Error al añadir la frase");

                        Log.i(UserActivity.class.getSimpleName(), response.raw().toString());
                    }
                }else{
                    Log.i(UserActivity.class.getSimpleName(), "Frase añadido sin respuesta");
        ...
        apiService.getFrases().enqueue(new Callback<List<Frase>>() {
            ...
            public void onResponse(Call<List<Frase>> call, Response<List<Frase>> response) {
                if(response.isSuccessful()) {
                    ...
                    Log.i(UserActivity.class.getSimpleName(), "Get frases not succesful");
